...
namespace crackpipe.Helper
{
    internal class WebHelper
    {
        ...
        internal static string GetRequest(string uri)
        {
            ...
            request.UserAgent = $"Crackpipe/{SettingsViewModel.Instance.Version}";
        ...
        public static async Task DownloadImageFromUrlAsync(string imageUrl, string cacheFile)
        {
            using (WebClient client = new WebClient())
            {
                ...
                client.Headers.Add($"User-Agent: Crackpipe/{SettingsViewModel.Instance.Version}");
            ...
            //    client.DefaultRequestHeaders.Add("User-Agent", $"Crackpipe/{SettingsViewModel.Instance.Version}");
