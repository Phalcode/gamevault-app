            ...
            catch (Exception ex)
            {
                ...
                switch (cacheType)
                {
                    case ImageCache.BoxArt:
                        {
                            return BitmapHelper.GetBitmapImage("pack://application:,,,/crackpipe;component/Resources/Images/library_NoBoxart.png");
                        }
                    case ImageCache.UserIcon:
                        {
                            return BitmapHelper.GetBitmapImage("pack://application:,,,/crackpipe;component/Resources/Images/com_NoUserIcon.png");
                        }
                    default:
                        {
                            return BitmapHelper.GetBitmapImage("pack://application:,,,/crackpipe;component/Resources/Images/gameView_NoBackground.png");
                        }
                }
            }
        }
