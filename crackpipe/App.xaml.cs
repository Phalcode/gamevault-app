...
namespace crackpipe
{
    ...
    public partial class App : Application
    {
        ...
        private async void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            if (pcount != 1)
            {
                var client = new NamedPipeClientStream("NamedCrackPipe");
                client.Connect();
        ...
        public void LogUnhandledException(Exception e)
        {
            ...
            string errorLogPath = $"{AppFilePath.ErrorLog}\\Crackpipe_ErrorLog_{DateTime.Now.ToString("yyyyMMddHHmmssfff")}.txt";
        ...
        private void StartServer()
        {
            Task.Factory.StartNew(() =>
            {
                while (true)
                {
                    using (var server = new NamedPipeServerStream("NamedCrackPipe"))
                    {
        ...
        private void InitNotifyIcon()
        {
            ...
            Stream iconStream = Application.GetResourceStream(new Uri("pack://application:,,,/crackpipe;component/Resources/Images/icon.ico")).Stream;
